...
<div class="space-y-6 max-w-md mx-auto">
  ...
  <h1 class="text-xl font-semibold text-cloud-white">Tạo tài khoản 🎀</h1>

  <label class="form-label text-cloud-white/80">Tên người dùng</label>
  <input id="reg_username" type="text" class="form-input" placeholder="vd: nean">

  <label class="form-label text-cloud-white/80 mt-2">Email</label>
